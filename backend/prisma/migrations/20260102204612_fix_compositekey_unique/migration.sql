...
INSERT INTO "new_LegalFact" ("category", "compositeKey", "createdAt", "date", "docId", "eliUri", "id", "impact", "ingestMethod", "legalStatus", "officialRationale", "sourceId", "sourceUrl", "summary", "title", "updatedAt") SELECT "category", "compositeKey", "createdAt", "date", "docId", "eliUri", "id", "impact", "ingestMethod", "legalStatus", "officialRationale", "sourceId", "sourceUrl", "summary", "title", "updatedAt" FROM "LegalFact";
